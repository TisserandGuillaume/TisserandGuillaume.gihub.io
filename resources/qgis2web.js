...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-147013.188387, 5997468.790446, 1718882.623061, 7223817.274295], maxZoom: 20, minZoom: 1, projection: new ol.proj.Projection({
            code: 'IGNF:LAMB93',
            extent: [99040.000000, 6049681.000000, 1242444.000000, 7110479.000000],
            units: 'm'})
    })
});


map.getView().fit([-147013.188387, 5997468.790446, 1718882.623061, 7223817.274295], map.getSize());
